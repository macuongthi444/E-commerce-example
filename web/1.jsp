<%-- 
    Document   : 1
    Created on : 06-11-2023, 18:40:14
    Author     : hoang
--%>
...
<html>
    ...
    <body>
        ...
        <div class="modal fade" id="modal-report" tabindex="-1" aria-labelledby="myExtraLargeModalLabel" style="display: block;" aria-modal="true" role="dialog">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="Blood" placeholder="">
                                            <option value=""></option>
