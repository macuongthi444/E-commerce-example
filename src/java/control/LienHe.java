...
public class LienHe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String s_dienthoai = request.getParameter("s_dienthoai");
        String s_email = request.getParameter("s_email");
        String s_address = request.getParameter("s_address");
        String s_title = request.getParameter("s_title");
        String s_message = request.getParameter("s_message");
        ...
        dao.LienHe(s_fullname, s_dienthoai, s_email, s_address, s_title, s_message);
